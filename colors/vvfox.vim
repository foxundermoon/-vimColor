" ============================================================================
" Name:     Vvfox vim color scheme
" Author:   foxUnderMoon <fox@Vvfox.com>
" Version:  1.0.0
" ----------------------------------------------------------------------------
"
...
" scheme. This will default to VvfoxDark for 'dark' and VvfoxLight for
" 'light'.
"
"
" Options:
...
if exists("g:Vvfox_style")
    let s:style = g:Vvfox_style
else
    let s:style = &background
endif

if exists("g:Vvfox_contrast")
    let s:contrast = g:Vvfox_contrast
else
    let s:contrast = "normal"
endif

if exists("g:Vvfox_contrast_bg")
    let s:contrast_bg = g:Vvfox_contrast_bg
else
    let s:contrast_bg = "normal"
endif

if exists("g:Vvfox_use_bold")
    let s:use_bold = g:Vvfox_use_bold
else
    let s:use_bold = 1
endif

if exists("g:Vvfox_use_underline")
    let s:use_underline = g:Vvfox_use_underline
else
...
function! SetVvfox(style, contrast, contrast_bg)
    let g:Vvfox_style = a:style
    let g:Vvfox_contrast = a:contrast
    let g:Vvfox_contrast_bg = a:contrast_bg
endfunction

command! VvfoxLight call SetVvfox("light", "normal", "normal")
            \ | colorscheme Vvfox
command! VvfoxLightLowContrast call SetVvfox("light", "low", "normal")
            \ | colorscheme Vvfox
command! VvfoxLightHighContrast call SetVvfox("light", "high", "normal")
            \ | colorscheme Vvfox

command! VvfoxWhite call SetVvfox("light", "normal", "high")
            \ | colorscheme Vvfox
command! VvfoxWhiteLowContrast call SetVvfox("light", "low", "high")
            \ | colorscheme Vvfox
command! VvfoxWhiteHighContrast call SetVvfox("light", "high", "high")
            \ | colorscheme Vvfox

command! VvfoxDark call SetVvfox("dark", "normal", "normal")
            \ | colorscheme Vvfox
command! VvfoxDarkLowContrast call SetVvfox("dark", "low", "normal")
            \ | colorscheme Vvfox
command! VvfoxDarkHighContrast call SetVvfox("dark", "high", "normal")
            \ | colorscheme Vvfox

command! VvfoxBlack call SetVvfox("dark", "normal", "high")
            \ | colorscheme Vvfox
command! VvfoxBlackLowContrast call SetVvfox("dark", "low", "high")
            \ | colorscheme Vvfox
command! VvfoxBlackHighContrast call SetVvfox("dark", "high", "high")
            \ | colorscheme Vvfox
